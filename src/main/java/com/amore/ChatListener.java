...
public class ChatListener extends ListenerAdapter {
    ...
    // Random question system: still chance-based, but with a safety cooldown to avoid spam.
    ...
    // Adjust these two numbers anytime to make prompts/sparks more or less frequent.
